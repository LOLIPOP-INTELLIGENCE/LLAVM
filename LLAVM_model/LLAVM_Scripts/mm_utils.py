...
def new_tokenizer(text, tokenizer):
    ...
    # Convert to list of integers and return
    return semantic_tokens[0].tolist()  # Convert tensor to list


def tokenizer_image_token(prompt, tokenizer, image_token_index=IMAGE_TOKEN_INDEX, return_tensors=None):
    prompt_chunks = [new_tokenizer(chunk,tokenizer) for chunk in prompt.split("<image>")]
